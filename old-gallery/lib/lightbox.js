...
(function (root, factory) {
  ...
  Lightbox.prototype.build = function() {
    var self = this;
    $('<div id="lightboxOverlay" class="lightboxOverlay"></div><div id="lightbox" class="lightbox"><div class="lb-outerContainer"><div class="lb-container"><img class="lb-image" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" /><div class="lb-nav"><a class="lb-prev" href="" ></a><a class="lb-next" href="" ></a><a class="lb-download" href=""></a></div><div class="lb-loader"><a class="lb-cancel"></a></div></div></div><div class="lb-dataContainer"><div class="lb-data"><div class="lb-details"><span class="lb-caption"></span><span class="lb-number"></span></div><div class="lb-closeContainer"><a class="lb-close"></a></div></div></div></div>').appendTo($('body'));
    ...
    /* Download of the image to the lightbox view */
    this.$lightbox.find('.lb-download').on('click', function () {
      /*window.location = 'kubo.js'
      self.end();*/
      ...
      if (imgUrl[37] ==  "/"){
        imgID = imgUrl.slice(38, 49);
        console.log(imgID);  
      } else {
        imgID = imgUrl.slice(37, 48);
        console.log(imgID);
      }
      

      var requestUrl = "https://api.flickr.com/services/rest/?method=flickr.photos.getSizes&api_key=d08ecb42498ff940dc0f1004f95046a1&photo_id=" + imgID + "&format=json&nojsoncallback=1"
      ...
      imgRequest.onreadystatechange = function() {
        if(this.readyState == 4 && this.status == 200){
          imgData = JSON.parse(imgRequest.response);
          orgImg = imgData.sizes.size[11].source;
          console.log(orgImg);
          downloadFile(orgImg);
          //window.open(orgImg, "_blank");
        }
      }
      imgRequest.open("GET", requestUrl, true);
      imgRequest.send();
